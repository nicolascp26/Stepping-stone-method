...
public class TransportationProblemWithoutFile {
    ...
    static void init() throws FileNotFoundException {
        ...
        int numSources = tec.nextInt();
        System.out.println("\n Ingresa el numero de Columnas: ");
        int numDestinations = tec.nextInt();

        List<Integer> src = new ArrayList<>();
        List<Integer> dst = new ArrayList<>();

        for (int i = 0; i < numSources; i++){
            System.out.println("\n Ingresa el valor " + i + " de la oferta: ");
            src.add(tec.nextInt());
        }
        for (int i = 0; i < numDestinations; i++){
            System.out.println("\n Ingresa el valor " + i + " de la demanda: ");
            dst.add(tec.nextInt());
        }
        // Arregla desbalance
        ...
        for (int i = 0; i < numSources; i++) {
            for (int j = 0; j < numDestinations; j++) {
                System.out.println("\n Ingresa el costo de " + i + " - "+ j +" : ");
                costs[i][j] = tec.nextDouble();
            }
        }
    }
    ...
    static void printResult() {
        ...
        System.out.printf("%nCOSTO MINIMO: %s%n%n", totalCosts);
    }
